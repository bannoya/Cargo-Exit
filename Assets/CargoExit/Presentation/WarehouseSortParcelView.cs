...
{
    public sealed class WarehouseSortParcelView :
        MonoBehaviour,
        IBeginDragHandler,
        IDragHandler,
        IEndDragHandler
    {
        private WarehouseSortPrototypeController controller;
        ...
        public string DestinationLetter { get; private set; }
        ...
        public void Initialize(
            WarehouseSortPrototypeController owner,
            ...
            float rotation)
        {
            ...
            var upperTape = PrototypeUi.Panel(
                rectTransform,
                "Tape Top",
            ...
            var lowerTape = PrototypeUi.Panel(
                rectTransform,
                "Tape Bottom",
